...
public class BowlingFrameTests {
    ...
    public void testRegularFrameStrike() {
        ...
        BowlingPlay play1 = new BowlingPlay("John", 10, false);
        ...
        BowlingPlay play2 = new BowlingPlay("John", 5, false);
        frame1.recordExtraBall(play2);
        frame1.scoreFrame();
        assertEquals(15, frame1.getScore());

        //The second
        BowlingPlay play3 = new BowlingPlay("John", 5, false);
        frame1.recordExtraBall(play3);
        frame1.scoreFrame();
        assertEquals(20, frame1.getScore());

        //But not a third
        BowlingPlay play4 = new BowlingPlay("John", 2, false);
    ...
    public void testRegularFrameSpare() {
        ...
        BowlingPlay play1 = new BowlingPlay("John", 7, false);
        BowlingPlay play2 = new BowlingPlay("John", 3, false);
        ...
        BowlingPlay play3 = new BowlingPlay("John", 2, false);
    ...
    public void testRegularFrameOpen() {
        ...
        BowlingPlay play1 = new BowlingPlay("John", 7, false);
        BowlingPlay play2 = new BowlingPlay("John", 2, false);
    ...
    public void testCreation10thFrameSpare() {
        //Create a strike
        BowlingFrame frame = new Bowling10thFrame(10);
        BowlingPlay play1 = new BowlingPlay("John", 9, false);
        //Strike should not finish the 10th frame right away, contrary to regular ones
        assertFalse(frame.addPlay(play1));
        ...
        //But being a strike it will count the next two balls
        BowlingPlay play2 = new BowlingPlay("John", 1, false);
        //Should not finish yet
        assertFalse(frame.addPlay(play2));
        frame.scoreFrame();
        assertEquals(10, frame.getScore());
    ...
    public void testCreation10thFrameOpen() {
        //Create a strike
        BowlingFrame frame = new Bowling10thFrame(10);
        BowlingPlay play1 = new BowlingPlay("John", 5, false);
        //Strike should not finish the 10th frame right away, contrary to regular ones
        assertFalse(frame.addPlay(play1));
